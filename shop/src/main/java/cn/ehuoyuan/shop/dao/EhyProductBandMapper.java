...
public interface EhyProductBandMapper {
	public int deleteByPrimaryKey(String bandId);

    public int insert(EhyProductBand record);
    ...
    public int updateByPrimaryKey(EhyProductBand record);
